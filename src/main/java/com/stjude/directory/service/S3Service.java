...
public class S3Service {
    ...
    public String uploadVicarImage(MultipartFile file) throws IOException {
        // Generate a unique file name for the image
        String fileName = "vicars/"+ file.getOriginalFilename();
    ...
    public String uploadParishCouncilImage(MultipartFile file) throws IOException {
        // Generate a unique file name for the image
        String fileName = "parish-councils/"+ file.getOriginalFilename();
